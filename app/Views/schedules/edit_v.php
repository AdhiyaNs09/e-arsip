        ...
        <div class="card-body">
          ...
          <form action="/schedule/<?= $schedules['jadwal_id']; ?>" method="post">
              ...
              <div class="col-sm-10">
                <select class="form-select" id="mapel_id" name="mapel_id">
                  <?php foreach ($studies as $m) : ?>
                    <option value="<?= $m['mapel_id'] ?>" <?= old('mapel_id') == $m['mapel_id'] ? 'selected' : '' ?>>
                      <?= $m['nama_mapel'] ?>
                    </option>
                  <?php endforeach; ?>
                </select>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input class="form-control <?= isset($errors['jam_mulai']) ? 'is-invalid' : '' ?>" type="text" id="jam_mulai" name="jam_mulai" value="<?= (old('jam_mulai')) ? old('jam_mulai') : $schedules['jam_mulai'] ?>">
                <div class="invalid-feedback">
                  <?= $errors['jam_mulai'] ?? '' ?>
                </div>
              </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input class="form-control <?= isset($errors['jam_selesai']) ? 'is-invalid' : '' ?>" type="text" id="jam_selesai" name="jam_selesai" value="<?= (old('jam_selesai')) ? old('jam_selesai') : $schedules['jam_selesai'] ?>">
                <div class="invalid-feedback">
                  <?= $errors['jam_selesai'] ?? '' ?>
                </div>
              </div>
