        ...
        <div class="card-body">
          ...
          <form action="/teacher" method="post">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input class="form-control <?= isset($errors['nama_guru']) ? 'is-invalid' : '' ?>" type="text" id="nama_guru" name="nama_guru" value="<?= old('nama_guru') ?>" autofocus>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control <?= isset($errors['nip']) ? 'is-invalid' : '' ?>" id="nip" name="nip" value="<?= old('nip') ?>">
                <div class="invalid-feedback">
                  <?= $errors['nip'] ?? '' ?>
                </div>
              </div>
